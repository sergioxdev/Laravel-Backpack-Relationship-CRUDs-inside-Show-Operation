...
use App\Models\Tool_building;

// VALIDATION: change the requests to match your own file names if you need form validation
use App\Http\Requests\Tool_buildingRequest as StoreRequest;
use App\Http\Requests\Tool_buildingRequest as UpdateRequest;
use Backpack\CRUD\CrudPanel;

/**
 * Class Tool_buildingCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class Tool_buildingCrudController extends CrudModController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        static::$controllernew = new Tool_buildingCrudController();

        $this->crud->setModel('App\Models\Tool_building');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/tool_building');
        $this->crud->setEntityNameStrings('tool_building', 'tool_buildings');
        ...
        */
        ...
        // add asterisk for fields that are required in Tool_buildingRequest
        ...
        $controller_new = [
            ...
            'sub_controller_new' => [
                '0' => [
                    ...
                    'controller' => new Tool_floorCrudController(),
                ],
            ],
        ];
    ...
    public function getTool_buildings()
    {
        $edificios = Tool_building::all(['id','name'])->toArray();
        if (is_array($edificios)) {
            $edificios = $edificios;
        } else {
            $edificios = ['NULL' => 'NULL'];
        }
        return response()->json(json_encode($edificios));
    }
}
