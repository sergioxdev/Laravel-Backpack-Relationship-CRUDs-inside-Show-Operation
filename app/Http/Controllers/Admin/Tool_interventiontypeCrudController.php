...
use App\Models\Tool_interventiontype;

// VALIDATION: change the requests to match your own file names if you need form validation
use App\Http\Requests\Tool_interventiontypeRequest as StoreRequest;
use App\Http\Requests\Tool_interventiontypeRequest as UpdateRequest;
use Backpack\CRUD\CrudPanel;

/**
 * Class Tool_interventiontypeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class Tool_interventiontypeCrudController extends CrudModController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        static::$controllernew = new Tool_interventiontypeCrudController();

        $this->crud->setModel('App\Models\Tool_interventiontype');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/tool_interventiontype');
        $this->crud->setEntityNameStrings('tool intervention type', 'tool intervention types');
        ...
        */
        ...
        // add asterisk for fields that are required in Tool_interventiontypeRequest
    ...
    {
        $model = Tool_interventiontype::find($id);
