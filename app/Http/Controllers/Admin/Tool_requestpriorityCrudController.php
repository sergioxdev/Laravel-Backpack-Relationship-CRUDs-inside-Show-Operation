...
use App\Models\Tool_requestpriority;

// VALIDATION: change the requests to match your own file names if you need form validation
use App\Http\Requests\Tool_requestpriorityRequest as StoreRequest;
use App\Http\Requests\Tool_requestpriorityRequest as UpdateRequest;
use Backpack\CRUD\CrudPanel;

/**
 * Class Tool_requestpriorityCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class Tool_requestpriorityCrudController extends CrudModController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        static::$controllernew = new Tool_requestpriorityCrudController();

        $this->crud->setModel('App\Models\Tool_requestpriority');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/tool_requestpriority');
        $this->crud->setEntityNameStrings('tool request priority', 'tool request priorities');
        ...
        */
        ...
        // add asterisk for fields that are required in Tool_requestpriorityRequest
    ...
    {
        $model = Tool_requestpriority::find($id);
