...
@endif
<br>
<a href="{{ url(Request::segments()[0].'/'.substr(Request::segments()[3], 0, -1).'/'.Request::segments()[4]) }}" class="hidden-print"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{Request::segments()[3] }}</span></a>
